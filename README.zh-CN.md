...
- [CoS](https://x.ai/bot/eiVFbd0nIdH2gzSwHOs0D) — 小队专家智能体的幕僚长：日历、项目、进站邮件，以及一份私密晨报。 [@theaaron](https://x.com/theaaron)
...
- [Overwatch](https://x.ai/bot/HtClSXO_AmiQoyYH9aXV9) — 让共享的多 Bot 工作区保持整齐、有 git 备份、可随身带走，并做工作日备份。 [@theaaron](https://x.com/theaaron)
...
- [Set Up](https://x.ai/bot/BsExflSUXpW0hs21OTBzu) — 带新 Grok Bot 用户搭一支小队：一名主管、几位项目负责人和若干专家。 [@theaaron](https://x.com/theaaron)
...
- [Grok Build](https://x.ai/bot/eydijdzrfgtnmlnUyPSI-) — 用真正的 Grok Build CLI 做应用、代码和深度调研，全力以赴。 [@BillZanetti](https://x.com/BillZanetti)
...
- [Nightly Audit Engineer](https://x.ai/bot/hkGSHcqKjGc5dm3ugNc2U) — 夜间工程审计员：研究整份代码库，然后每个区域只交付一项清理。 [@daisuke](https://x.com/daisuke)
...
- [Usage-pool orchestrator](https://x.ai/bot/Nx4wpKeM_NYx577xlJFMD) — 默认把重活交给 Cursor，也可选 Grok Build、Claude Code 或 Codex，让那些用量池干活。 [@JordanHall_dev](https://x.com/JordanHall_dev)
...
- [Blunt](https://x.ai/bot/N0J32FbnVRuetJi1oJggh/talsiach) — 资深产品营销人的落地页评审：发一个 URL，得到优点、缺点、该先改的一件事，以及分数。 [@Talsiach](https://x.com/Talsiach)
...
- [4 Panez](https://x.ai/bot/91R37-rUOh9sS1tZkIF9d) — 画一幅超宽 16:9 场景，切成四块可滑动画幅，并以说唱歌手口吻说话。 [@SuddenlyJon](https://x.com/SuddenlyJon)
...
- [Homeroom](https://x.ai/bot/IciOb-9jMtlkc1RJj6MQe) — 家长助手：拉取 Schoology，维护家庭作业站点，并快照学校活动。 [@ahalvor](https://x.com/ahalvor)
